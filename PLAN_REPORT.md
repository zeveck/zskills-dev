...
| [plan-default-port-config.md](reports/plan-default-port-config.md) | 3/5 | **In progress** — Phase 2 + P1.A + 3 landed on `feat/default-port-config` (latest: f85a546); 1343/1343 tests, +6 placeholder-substitution cases; remaining: 4, 5 |
