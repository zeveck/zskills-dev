...
|--------|--------|--------|
| [plan-pr-landing-unification.md](reports/plan-pr-landing-unification.md) | 3/7 | **In progress** — Phase 1A (PR #159 `1c6c143`): /land-pr skill + 4 scripts + 2 references + mirror; smoke PR #158; 1722 tests. Phase 1B (PR #160 `8d9bc13`): failure-modes.md (10 modes) + 2 mocks + 23 unit tests + 37 conformance + 5 helpers; +60 tests. Phase 2 (this PR): /run-plan PR mode migrated to dispatch /land-pr; modes/pr.md 681→545; 0 inline gh pr create/merge/checks --watch; +4 run-plan conformance + tests/test-landed-schema.sh (6 cases); 1782→1792 tests. WI 2.9 (canary) deferred to Phase 3 fire (architectural; subagent constraint) |
