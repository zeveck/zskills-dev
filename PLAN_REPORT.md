...
|--------|--------|--------|
| [plan-consumer-stub-callouts-plan.md](reports/plan-consumer-stub-callouts-plan.md) | 1/7 | **In progress** — Phase 1 (staleness regression guard) passed; Phases 2-7 remaining |
