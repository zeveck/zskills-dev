...
|--------|--------|--------|
| [plan-scripts-into-skills-plan.md](reports/plan-scripts-into-skills-plan.md) | 2/7 | **In progress** — Phases 1+2 done (registry + 7 single-owner Tier-1 scripts moved into owning skills with caller updates and history preserved); Phases 3a, 3b, 4, 5, 6 remaining |
