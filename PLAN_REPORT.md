...
| [plan-default-port-config.md](reports/plan-default-port-config.md) | 4/5 | **In progress** — Phase 2 + P1.A + 3 + 4 landed on `feat/default-port-config` (latest: 623f6df); 1348/1348 tests; remaining: 5 |
