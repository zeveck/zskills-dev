...
|--------|--------|--------|
| [plan-pr-landing-unification.md](reports/plan-pr-landing-unification.md) | 1/7 | **In progress** — Phase 1A landed on `feat/pr-landing-unification` (this PR): `/land-pr` skill + 4 scripts (`pr-rebase.sh`, `pr-push-and-create.sh`, `pr-monitor.sh`, `pr-merge.sh`) + 2 references (caller-loop-pattern, fix-cycle-agent-prompt-template) + mirror; smoke PR #158 created+closed; 1722/1722 tests; shellcheck clean; bug fix: BRANCH_SLUG for `/tmp` paths |
