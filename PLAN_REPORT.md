...
| [plan-default-port-config.md](reports/plan-default-port-config.md) | 2/5 | **In progress** — Phase 2 + P1.A landed on `feat/default-port-config` (abc0c32, 7259b91, b66bbc5); 1275/1275 tests; remaining: 3, 4, 5 |
