...
|--------|--------|--------|
| [plan-draft-tests-skill-plan.md](reports/plan-draft-tests-skill-plan.md) | 3/6 | **In progress** — Phases 1+2+3 done (skeleton + language detection + drafting agent & test-spec format with single-source-of-truth delegate/ac-less skip); 1470/1470 tests on `feat/draft-tests-skill-plan`; Phases 4–6 chunked via finish-auto cron |
