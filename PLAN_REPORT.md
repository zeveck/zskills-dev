...
|--------|--------|--------|
| [plan-draft-tests-skill-plan.md](reports/plan-draft-tests-skill-plan.md) | 4/6 | **In progress** — Phases 1+2+3+4 done (skeleton + language detection + drafting agent + adversarial review loop with orchestrator-judgment convergence and merged-candidate coverage-floor pre-check); 1549/1549 tests on `feat/draft-tests-skill-plan`; Phases 5–6 chunked via finish-auto cron |
