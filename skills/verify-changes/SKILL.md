...
to `$ZSKILLS_REPORTS_DIR/verify-{scope-slug}.md` and regenerate the index — but ONLY
...
1. **Scan** `$ZSKILLS_REPORTS_DIR/verify-*.md` files
...
If there are no `$ZSKILLS_REPORTS_DIR/verify-*.md` files (e.g., all were cleaned up),
