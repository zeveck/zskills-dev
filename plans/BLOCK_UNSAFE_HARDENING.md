...
| 5 — CHANGELOG + class-pinned acceptance canaries + drift gate + finalization | 🟡 In Progress | — | 144-case + 192-case matrices; 4 known reproducers; new `tests/test-hook-helper-drift.sh`; PLAN_INDEX update |
