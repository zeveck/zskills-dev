...
|-------|--------|--------|-------|
| 1 — Decision, agent-definition authoring, hook script | ✅ | `89d1b57` | Implemented + verified (2056/2056 tests). Canary PASSED 2026-05-03 — dispatched canary-readonly subagent (`tools: Read`) was unable to call Bash; structural-allowlist claim verified for Claude Code 2.1.126. Phases 2-6 proceed. |
