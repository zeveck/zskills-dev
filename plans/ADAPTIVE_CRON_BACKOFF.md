...
| 2 — Documentation: finish-mode.md table + failure-protocol.md cleanup step | ✅ Done | _pending commit_ | Backoff table + reset triggers + DA4/DA5/A1/N2 prose in finish-mode.md; new step 5 in failure-protocol.md |
