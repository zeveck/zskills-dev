...
| 4 — Mirror, invariants, run-all.sh, regression check | ✅ Done | _pending commit_ | run-all.sh registers new test (line 52); test-skill-invariants extended +4 #110 anchors (36→40 pass); mirror parity confirmed |
