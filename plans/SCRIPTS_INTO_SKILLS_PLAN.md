...
| 2 — Move single-owner Tier 1 scripts (apply-preset, compute-cron-fire, post-run-invariants, briefing.*, statusline) | 🟡 | `e401209` | 7 scripts moved; 22 files modified; 931/931 |
