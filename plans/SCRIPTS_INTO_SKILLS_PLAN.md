...
| 3b — Update cross-skill callers (grep-driven sweep across skills/ .claude/skills/ CLAUDE.md README.md RELEASING.md) and tests | 🟡 | `64dc37d` | 13 skills + hooks + 6 tests + docs swept; port.sh PROJECT_ROOT fix; 894→931 tests |
