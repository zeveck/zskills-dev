...
| 4 — Update `/update-zskills` install flow: drop Tier-1 copies, install via skill mirror, add stale-Tier-1 migration | 🟡 | `18404ae` | Step D rewrite + Step D.5 migration + tier1-shipped-hashes.txt; port_script strip; 943/943 tests (+12 migration cases) |
