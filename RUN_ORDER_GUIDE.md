...
- [~] `/draft-plan plans/ADAPTIVE_CRON_BACKOFF.md` — landed via PR #131 (2026-04-30; `/draft-plan` 2 rounds adversarial review; Mode A only; Mode B deferred to #134)
- [~] `/run-plan plans/ADAPTIVE_CRON_BACKOFF.md` — in flight as PR #138 (2026-04-30; 4 phases all complete on `feat/adaptive-cron-backoff`; plan `status: complete`; Issue #110 closed; awaiting merge)
